...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def save_checkpoint(self, local_path: str, global_step: int, remove_previous_ckpt=False, *args, **kwargs):
        ...
        # print(f"[rank-{self.rank}]: Starting to merge FSDP shards into HuggingFace format...")
        ...
        #         print(f"[rank-{self.rank}]: Saving merged model to {os.path.abspath(model_save_path)}")
...
if __name__ == '__main__':
    ...
    checkpoint_path = "./global_step_16/actor"
